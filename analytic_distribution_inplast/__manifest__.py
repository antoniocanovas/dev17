...

{
    ...
    "data": [
        ...
        'views/analytic_distribution_parameter_views.xml',
        'views/res_company_views.xml',
        'views/account_account_views.xml',
        'views/account_analytic_account_views.xml',
        'views/analytic_distribution_views.xml',
        'views/account_asset_views.xml',
        'views/mrp_maintenance_issue_views.xml',
        'views/mrp_production_legacy_views.xml',
        'data/analytic_distribution_parameter.xml',
    ],
    "demo": [],
    "installable": True,
    "auto_install": False,
